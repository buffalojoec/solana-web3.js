            ...
            expect(result).toMatchObject({
                data: {
                    account: {
                        owner: {
                            executable: true,
                            lamports: expect.any(String),
                            rentEpoch: expect.any(String),
                        },
                    },
                },
            });
                        ...
                        data: {
                            parsed: {
                                info: {
                                    ...
                                    stake: {
                                        creditsObserved: expect.any(String),
                                        delegation: {
                                            activationEpoch: expect.any(String),
                                            deactivationEpoch: expect.any(String),
